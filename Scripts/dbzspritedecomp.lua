...
LIST_DATA = {
--   { name = "font.bin"   , adr = 0x040000 },
   { name = "Goku Overworld.bin" , adr = 0x781F7, mode = "sprite" },
   { name = "Gohan Overworld.bin" , adr = 0x789F7, mode = "sprite" },
   { name = "Gohan Battle #1.bin" , adr = 0x1D9729-0x0F0000, mode = "sprite" },
   { name = "Gohan Battle #2.bin" , adr = 0x0E97F9, mode = "sprite" },
   { name = "Gohan Battle #3.bin" , adr = 0x0E98CE, mode = "sprite" },
   { name = "Gohan Battle #4.bin" , adr = 0x0E99CC, mode = "sprite" },
   { name = "Gohan Battle #5.bin" , adr = 0x0E9AAE, mode = "sprite" },
}
...
function dbzdecomp()
   ...
   for _, data in ipairs(LIST_DATA) do
      print("Decompression de " .. data.name)
